...
class ArgumentsForBatchedStatement {
  ...
  /// Construct the object from map generated by `toMap`
  ArgumentsForBatchedStatement.fromMap(Map<String, dynamic> map)
    : this(map['statementIndex'] as int, map['arguments'] as List);
  ...
  /// Convert the object to map, the object can be constructed
  /// with `fromMap` constructor
  @override
